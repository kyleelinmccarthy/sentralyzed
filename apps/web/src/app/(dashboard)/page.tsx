...
export default function DashboardPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-jet mb-6">
        Welcome back, {user?.name?.split(' ')[0] || 'there'}
      </h1>

      {/* Feature Cards */}
      <div className="grid grid-cols-2 gap-4 mb-8">
        <Card gradient="linear-gradient(135deg, #7B1FA2, #9C27B0)" className="p-6 text-white">
      ...
      <Card className="p-6">
        ...
        <p className="text-sm text-french-gray">No tasks yet. Create a project to get started.</p>
      </Card>
    </div>
  )
}
